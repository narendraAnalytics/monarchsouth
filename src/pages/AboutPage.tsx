  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', fontFamily: "'Space Mono', monospace" }}>
        ...
        <p style={{ color: '#7a9cc4', fontSize: '12px', letterSpacing: '0.15em', marginBottom: '8px', maxWidth: '400px' }}>
          ENGINEERED FOR THE BOLD. WORN BY THE FEW.
        </p>
        <p style={{ color: 'rgba(122,156,196,0.5)', fontSize: '11px', letterSpacing: '0.1em', marginBottom: '40px' }}>
