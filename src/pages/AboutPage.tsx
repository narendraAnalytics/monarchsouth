  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', fontFamily: "'Space Mono', monospace" }}>
        ...
        <p style={{ color: '#c9a96e', fontSize: '12px', letterSpacing: '0.15em', marginBottom: '8px', maxWidth: '400px' }}>
          ENGINEERED FOR THE BOLD. WORN BY THE FEW.
        </p>
        <p style={{ color: 'rgba(201,169,110,0.5)', fontSize: '11px', letterSpacing: '0.1em', marginBottom: '40px' }}>
